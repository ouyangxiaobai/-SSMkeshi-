...
<title></title>
	<meta charset="utf-8" />
 <script type="text/javascript" src="<%=basePath%>media/shoufei/js/jquery-1.10.2.min.js"></script>
 <script type="text/javascript" src="<%=basePath%>media/shoufei/js/getIp.js"></script>
 <script type="text/javascript" src="<%=basePath%>media/shoufei/js/ian.js"></script>
  <script type="text/javascript" src="<%=basePath%>media/shoufei/js/page.js"></script>
  <script type="text/javascript" src="<%=basePath%>media/shoufei/js/pageMedia.js"> </script>
<script type="text/javascript" src="<%=basePath%>media/shoufei/js/commcom.js"></script>

<script type="text/javascript" src="<%=basePath%>media/shoufei/js/shoufeiList.js"></script>
<link rel="stylesheet" href="<%=basePath%>media/shoufei/css/bootstrap.min.css" type="text/css"></link>
...
<div class="tab-content contents"> 
	<h3 class="form-section">&nbsp;&nbsp;&nbsp;<font style="font-weight:bold" >收费 管理</font></h3>
	<div class="row-fluid">
