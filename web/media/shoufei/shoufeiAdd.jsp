...
<script type="text/javascript" src="<%=basePath%>media/shoufei/js/ajaxfileupload.js"></script>
<script type="text/javascript" src="<%=basePath%>media/shoufei/js/getIp.js"></script>
<script type="text/javascript" src="<%=basePath%>media/shoufei/js/shoufeiAdd.js"></script>

  
  <link rel="stylesheet" href="<%=basePath%>media/shoufei/css/bootstrap.min.css" type="text/css"></link>
  	<link rel="stylesheet" href="<%=basePath%>media/shoufei/css/uploadify.css" type="text/css"></link>
...
<div class="tab-content contents"> 
	<h3 class="form-section" >&nbsp;&nbsp;&nbsp;<font style="font-weight:bold">收费添加</font></h3>
	<div class="row-fluid">
		<div class="span12">
		...
		<div class="form-horizontal m-t">
            <div class="control-group">
              ...
              <div class="control-group">
               ...
               <input id="a2" name="a2" minlength="2" type="text" class="form-control" required="" aria-required="true">
