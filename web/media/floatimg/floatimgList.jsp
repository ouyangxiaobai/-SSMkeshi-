...
<head>
 ...
 <link rel="stylesheet" type="text/css" href="media/css/bootstrap-cerulean.css" />
 	...
 	<script type="text/javascript" src="media/floatimg/js/floatimgList.js"></script>
...
<div class="tab-content contents"> 
	...
	<div class="row-fluid">
		<div class="span12">
	     ...
	     <span id="addbutton" class="btn btn-success">添加</span>
	        <span id="delbutton" class="btn btn-success">删除</span>
		</div>
