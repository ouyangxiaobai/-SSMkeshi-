...
<script type="text/javascript" src="<%=basePath%>media/bingfang/js/ajaxfileupload.js"></script>
<script type="text/javascript" src="<%=basePath%>media/bingfang/js/getIp.js"></script>
<script type="text/javascript" src="<%=basePath%>media/bingfang/js/bingfangAdd.js"></script>

  
  <link rel="stylesheet" href="<%=basePath%>media/bingfang/css/bootstrap.min.css" type="text/css"></link>
  	<link rel="stylesheet" href="<%=basePath%>media/bingfang/css/uploadify.css" type="text/css"></link>
...
<div class="tab-content contents"> 
	<h3 class="form-section" >&nbsp;&nbsp;&nbsp;<font style="font-weight:bold">病房管理</font></h3>
	<div class="row-fluid">
		<div class="span12">
