...
<title></title>
 ...
 <script type="text/javascript" src="<%=basePath%>media/liuyan/js/ian.js"></script>
  <script type="text/javascript" src="<%=basePath%>media/liuyan/js/page.js"></script>
  <script type="text/javascript" src="<%=basePath%>media/liuyan/js/pageMedia.js"> </script>
<script type="text/javascript" src="<%=basePath%>media/liuyan/js/commcom.js"></script>

<script type="text/javascript" src="<%=basePath%>media/liuyan/js/liuyanList.js"></script>
	 ...
	 <form class="layui-form xbs" action="">
                <div class="layui-form-pane" style="text-align: center;">
                  <div class="layui-form-item" style="display: inline-block;">
                    <label class="layui-form-label xbs768">留言名</label> 
                    <div class="layui-input-inline xbs768">
                      <input class="layui-input"  id="a1" placeholder="请输入留言名" id="LAY_demorange_e">
                    </div> 
