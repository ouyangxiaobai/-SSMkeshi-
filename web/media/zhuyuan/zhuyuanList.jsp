...
<title></title>
 ...
 <script type="text/javascript" src="<%=basePath%>media/zhuyuan/js/ian.js"></script>
  <script type="text/javascript" src="<%=basePath%>media/zhuyuan/js/page.js"></script>
  <script type="text/javascript" src="<%=basePath%>media/zhuyuan/js/pageMedia.js"> </script>
<script type="text/javascript" src="<%=basePath%>media/zhuyuan/js/commcom.js"></script>

<script type="text/javascript" src="<%=basePath%>media/zhuyuan/js/zhuyuanList.js"></script>
...
<div class="tab-content contents"> 
	<h3 class="form-section">&nbsp;&nbsp;&nbsp;<font style="font-weight:bold" >住院 管理</font></h3>
	<div class="row-fluid">
