...
<title></title>
	<meta charset="utf-8" />
 <script type="text/javascript" src="<%=basePath%>media/chuyuan/js/jquery-1.10.2.min.js"></script>
 <script type="text/javascript" src="<%=basePath%>media/chuyuan/js/getIp.js"></script>
 <script type="text/javascript" src="<%=basePath%>media/chuyuan/js/ian.js"></script>
  <script type="text/javascript" src="<%=basePath%>media/chuyuan/js/page.js"></script>
  <script type="text/javascript" src="<%=basePath%>media/chuyuan/js/pageMedia.js"> </script>
<script type="text/javascript" src="<%=basePath%>media/chuyuan/js/commcom.js"></script>

<script type="text/javascript" src="<%=basePath%>media/chuyuan/js/chuyuanList.js"></script>
<link rel="stylesheet" href="<%=basePath%>media/chuyuan/css/bootstrap.min.css" type="text/css"></link>
...
<div class="tab-content contents"> 
	<h3 class="form-section">&nbsp;&nbsp;&nbsp;<font style="font-weight:bold" >出院 管理</font></h3>
	<div class="row-fluid">
	 ...
	 <form class="layui-form xbs" action="">
                <div class="layui-form-pane" style="text-align: center;">
                  <div class="layui-form-item" style="display: inline-block;">
                    <label class="layui-form-label xbs768">学生名</label> 
                    <div class="layui-input-inline xbs768">
                      <input class="layui-input"  id="a1" placeholder="请输入学生名" id="LAY_demorange_e">
                    </div> 
	           ...
	           <thead>
	               <tr>
	                   <th style="width:5%;"><input type="checkbox"  id="queryCheckbox"  name="queryCheckbox" value=""></th>
	                    <th style="width:10%;">病人名</th>
	                     
	                    <th style="width:10%;">病房</th>
	                    <th style="width:10%;">出院号</th>
	                    <th style="width:10%;">性别</th>
	                    <th style="width:10%;">治疗结果</th>
