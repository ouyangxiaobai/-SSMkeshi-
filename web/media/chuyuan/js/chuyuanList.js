...
$(function(){
    ...
    getData();
   	...
   	$("#addbutton").on("click",function(){
   		...
   		window.location.href=getIP()+"media/chuyuan/chuyuanAdd.jsp";
   	})
    ...
    $("#delbutton").on("click",function(){
    	...
    	if(confirm("确定要删除吗？")){
        	...
        	del.ajax(getIP()+"chuyuan.action?delMore",function(data){
        		if(data.success){
    ...
    function getData(){  
	   	...
	   	getPageData(sel,getIP()+"chuyuan.action?list",function(data){
	   		if(data.success){
	   			var len=data.total;
...
//修改
function update(id){
	window.location.href=getIP()+"media/chuyuan/chuyuanModify.jsp?eid="+id;
}
