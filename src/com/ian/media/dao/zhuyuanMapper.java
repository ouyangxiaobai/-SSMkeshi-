...
public interface zhuyuanMapper extends BaseDao<zhuyuan, String> {
	/*
    ...
    List<students> selectByExampleWithBLOBs(studentsExample example);
    ...
    int updateByExampleWithBLOBs(@Param("record") students record, @Param("example") studentsExample example);
