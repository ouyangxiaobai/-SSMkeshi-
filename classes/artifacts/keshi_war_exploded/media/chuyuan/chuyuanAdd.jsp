...
<script type="text/javascript" src="<%=basePath%>media/chuyuan/js/ajaxfileupload.js"></script>
<script type="text/javascript" src="<%=basePath%>media/chuyuan/js/getIp.js"></script>
<script type="text/javascript" src="<%=basePath%>media/chuyuan/js/chuyuanAdd.js"></script>

  
  <link rel="stylesheet" href="<%=basePath%>media/chuyuan/css/bootstrap.min.css" type="text/css"></link>
  	<link rel="stylesheet" href="<%=basePath%>media/chuyuan/css/uploadify.css" type="text/css"></link>
...
<div class="tab-content contents"> 
	<h3 class="form-section" >&nbsp;&nbsp;&nbsp;<font style="font-weight:bold">出院添加</font></h3>
	<div class="row-fluid">
		<div class="span12">
	 <div class="portlet-body list mbModify">
		<div class="form-horizontal m-t">
            <div class="control-group">
             ...
             <div class="control-group">
                <label class="control-label">出院号：</label>
                <div class="controls">
                <p>
