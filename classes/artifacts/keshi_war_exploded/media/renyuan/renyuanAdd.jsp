...
<script type="text/javascript" src="<%=basePath%>media/renyuan/js/ajaxfileupload.js"></script>
<script type="text/javascript" src="<%=basePath%>media/renyuan/js/getIp.js"></script>
<script type="text/javascript" src="<%=basePath%>media/renyuan/js/renyuanAdd.js"></script>

  
  <link rel="stylesheet" href="<%=basePath%>media/renyuan/css/bootstrap.min.css" type="text/css"></link>
  	<link rel="stylesheet" href="<%=basePath%>media/renyuan/css/uploadify.css" type="text/css"></link>
...
<div class="tab-content contents"> 
	<h3 class="form-section" >&nbsp;&nbsp;&nbsp;<font style="font-weight:bold">人员添加</font></h3>
	<div class="row-fluid">
		<div class="span12">
