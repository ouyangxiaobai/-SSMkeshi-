...
<title></title>
 ...
 <script type="text/javascript" src="<%=basePath%>media/renyuan/js/ian.js"></script>
  <script type="text/javascript" src="<%=basePath%>media/renyuan/js/page.js"></script>
  <script type="text/javascript" src="<%=basePath%>media/renyuan/js/pageMedia.js"> </script>
<script type="text/javascript" src="<%=basePath%>media/renyuan/js/commcom.js"></script>

<script type="text/javascript" src="<%=basePath%>media/renyuan/js/renyuanList.js"></script>
...
<div class="tab-content contents"> 
	<h3 class="form-section">&nbsp;&nbsp;&nbsp;<font style="font-weight:bold" >医护人员 管理</font></h3>
	<div class="row-fluid">
	
		 <form class="layui-form xbs" action="">
                <div class="layui-form-pane" style="text-align: center;">
                  <div class="layui-form-item" style="display: inline-block;">
                    <label class="layui-form-label xbs768">人员名</label> 
                    <div class="layui-input-inline xbs768">
                      <input class="layui-input"  id="a1" placeholder="请输入人员名" id="LAY_demorange_e">
                    </div> 
	           ...
	           <thead>
	               <tr>
	                   <th style="width:5%;"><input type="checkbox"  id="queryCheckbox"  name="queryCheckbox" value=""></th>
	                    <th style="width:10%;">医护人员姓名</th>
	                     
	                    <th style="width:10%;">性别</th>
	                    <th style="width:10%;">年龄</th>
	                    <th style="width:10%;">毕业学校</th>
