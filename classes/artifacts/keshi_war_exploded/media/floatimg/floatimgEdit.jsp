...
<head>
	<meta charset="utf-8" />
 	...
 	<script type="text/javascript" src="media/floatimg/js/floatimgEdit.js"></script>
  	<style>
 		li{ list-style: none;}
 		.courseDbDetails{
 			width: 100%;
		...
		<div class="form-horizontal m-t">
            ...
            <div class="control-group" >
                ...
                <div class="controls" id="radio2">
                 ...
                 <input type="radio" name="optionsRadios2"  value="1" /> 开启
                 </div>
            </div>
            <div class="control-group">
            ...
            <div class="form-actions">
				<button id="add" onclick="addsssss()" type="button" class="btn blue">保存</button>
